...
function isOdd(x) {
    if(x===positiveOddNumber) {
        return true
    }
    if(x===negativeOddNumber) {
        return true
    }
    if(x===positiveEvenNumber) {
        return false
    }
    if(x===negativeEvenNumber) {
        return false
    }
}
...
function startsAndEndsWithVowel(x){
    ...
    for(let index = 0; index < vowels.length; index++) {
        let vowel = vowels[index];
        let split = x.split("");
        if (split[lengthMinusOne]===vowel&&split[0]===vowel) {
            return true;
        }
    }
    return false;
